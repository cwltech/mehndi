...
class TermsAndConditionsPage extends GetView<HomePageController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: "Terms and Condition".f14w4(
      ...
      body: ListView(
        ...
        children: [
          controller.termsAndConditionData.value.pageData![1].heading!
              .f14w4(
                  textColor: KColors.persistentBlack,
                  fontFamily: Fontfamily.poppins,
                  fontWeight: FontWeight.w600)
          ...
          Html(
            shrinkWrap: true,
            data:
                controller.termsAndConditionData.value.pageData![1].description,
            style: {
              "body": Style(
